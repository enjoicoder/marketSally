...
<section class="container">
	...
	<div id="product_list_category">
		...
		<ul class="list-group list-group-horizontal-md border justify-content-between p-2 my-4 text-hover-purple">
			<li class="list-group-item border-0"><a href="${contextPath}/ProdList.do" class="text-decoration-none">전체보기</a></li>
		...
		<div class="row">
<%
	List<ProdVO> list  = (List<ProdVO>)request.getAttribute("searchedResult");
%>
				...
				<div class="card border-light" style="width: 19rem;">
					<div class="product">
						<a href="<%=request.getContextPath() %>/ProdDetail.do?prodId=<%=prodvo.getProd_id() %>">
							<img src="<%=request.getContextPath() %>/img/product/<%=prodvo.getProd_img() %>" class="card-img-top" alt="<%=prodvo.getProd_img() %>">
						</a>
						<img class="cart"></img>
					</div>
					<div class="card-body">
