...
<% String lname = (String)request.getAttribute("lprodname");
...
<section class="container">
	...
	<div class="mt-4 justify-content-center">
		<!-- 상품배너 -->
		<img src="${contextPath}/img/categorybanner/categorybanner${param.lprodId}.webp" alt="categorybanner1.jsp">
	</div>

	<h3 class="text-center mt-5">${lprodname}</h3>
	...
	<div id="product_list_category">
		...
		<ul class="list-group list-group-horizontal-md border justify-content-between p-2 my-4 text-hover-purple">
			<li class="list-group-item border-0"><a href="${contextPath}/ProdList.do">전체보기</a></li>
		...
		<div class="row">
<%
	List<ProdVO> list  = (List<ProdVO>)request.getAttribute("lprodList");
%>
