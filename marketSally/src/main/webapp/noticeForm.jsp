...
<form method="post" action="${pageContext.request.contextPath}/noticeAdd.do">
	...
	<table class="detail_table">
		<tr>
			<th>제목</th>
			<td colspan="3"><input type="text" id="notice-title" class="table-input" name ="notice_title" placeholder="제목을 입력해주세요" style="width:100%; border: 0;"/></td>
		</tr>
		<tr>
			<th>작성자</th>
			<td colspan="3"><input type="text" id="mem-id" class="table-input" name ="mem_id" placeholder="나중에 수정" style="width:100%; border: 0;"/></td>
		</tr>
		<tr>
			<th>작성일</th>
		...
		<tr>
			<th>내용</th>
			<td colspan="3" class="detail-content p-10"><textarea name="notice_cont" rows="10" style="width:100%; border: 0; resize:none;"></textarea></td>
		</tr>
	</table>
	...
	<div class="text-right mt-3">
		...
		<button type="submit" id="submitBtn" class="w-btn">등록</button>
	</div>
